...
primary_searchengine = "rofi -show drun"
secondary_searchengine = "dmenu_run"
file_manager = terminal + " -e ranger"

# Set wallpaper
wallpaper_path = os.path.expanduser("~/Wallpapers/0279.jpg")
os.system("nitrogen --set-scaled {}".format(wallpaper_path))
...
keys = [
    ...
    Key([mod, "shift"], "Return", lazy.spawn(primary_searchengine)),
